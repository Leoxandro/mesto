...
let popupEditWin = document.querySelector('.popup__edit');
let popupAddWin = document.querySelector('.popup__add');
let popupFullScreen = document.querySelector('.popup__photo');
