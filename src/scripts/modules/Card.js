export class Card {
    ...
    generate = () => {
        ...
        this._cardBody = this._cardTemp.querySelector('.element');
        ...
        this.likeCounter = this._cardTemp.querySelector('.cards__like-counter');
        this._cardTemp.querySelector('.element__name').textContent = this._name;
